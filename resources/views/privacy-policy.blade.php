...
@section('title', 'iServices/'.__('Privacy Policy'))
@section('commonsection')
    ...
    <section class="breadcrumbs-custom bg-image context-dark scroll-handler" style="background-image: url({{asset('images/bg-breadcrumbs.jpg')}});">
        ...
        <div class="breadcrumbs-main">
            <div class="container">
                <h2 class="breadcrumbs-custom-title scroll-title">{{__('Privacy Policy')}}</h2>
            </div>
        </div>
    ...
    <section class="section section-lg bg-default">
        <div class="container">
            ...
            </dl><a class="privacy-link" href="#" onclick="return false;"><span class="__cf_email__" >iservices.cm@gmail.com</span></a>
        </div>
    </section>
