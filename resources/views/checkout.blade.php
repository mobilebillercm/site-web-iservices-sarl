...
<div class="page">
    ...
    <section class="breadcrumbs-custom bg-image context-dark scroll-handler" style="background-image: url(images/bg-breadcrumbs.jpg);">
        ...
        <div class="breadcrumbs-main">
            <div class="container">
                <h2 class="breadcrumbs-custom-title scroll-title">Checkout</h2>
            </div>
        </div>
                ...
                <div class="col-md-10 col-lg-6">
                    ...
                    <form class="rd-form rd-mailform form-checkout">
                        <div class="row row-20 gutter-20">
                            ...
                            <div class="col-sm-6">
                                <div class="form-wrap">
                                    <input class="form-input" id="checkout-postcode-1" type="text" name="name" data-constraints="@Required"/>
                ...
                <div class="col-md-10 col-lg-6">
                    ...
                    <form class="rd-form rd-mailform form-checkout">
                        <div class="row row-20 gutter-20">
                            ...
                            <div class="col-sm-6">
                                <div class="form-wrap">
                                    <input class="form-input" id="checkout-postcode-2" type="text" name="name" data-constraints="@Required"/>
        ...
        <div class="container">
            ...
            <div class="table-custom-responsive">
                <table class="table-custom table-cart">
                    ...
                    <tr>
                        <td>
                            <div class="table-cart-item"><a class="table-cart-figure" href="single-product.html"><img src="images/product-mini-1-146x132.png" alt="" width="146" height="132"/></a><a class="table-cart-link" href="single-product.html">Blue Fitness Tracker</a></div>
                        </td>
                        <td>$250</td>
                        <td>
                    ...
                    <tr>
                        <td>
                            <div class="table-cart-item"><a class="table-cart-figure" href="single-product.html"><img src="images/product-mini-2-146x132.png" alt="" width="146" height="132"/></a><a class="table-cart-link" href="single-product.html">Green Fitness Tracker</a></div>
                        </td>
                        <td>$290</td>
                        <td>
                            <div class="stepper-style-2">
        ...
        <div class="container">
            <div class="row row-30 justify-content-center">
                ...
                <div class="col-md-6">
                    <h4>Cart total</h4>
                    <div class="table-custom-responsive">
                        <table class="table-custom table-checkout">
                            <tbody>
                            <tr>
                                <td>Cart Subtotal</td>
                                <td>$540</td>
            ...
            <div class="text-right offset-top-5">
                <button class="button button-lg button-gradient" type="button">Checkout</button>
            </div>
        </div>
    </section>
                    ...
                    <div class="col-md-3">
                        <div class="inset-xl-left-70">
                            ...
                            <ul class="contacts-modern">
                                ...
                                <li><a href="tel:#">+1 800 123 1234</a><br><a href="/cdn-cgi/l/email-protection#a380"><span class="__cf_email__" data-cfemail="3851565e57785c5d55575451565316574a5f">[email&#160;protected]</span></a></li>
                            </ul>
                        </div>
                    </div>
                </div>
