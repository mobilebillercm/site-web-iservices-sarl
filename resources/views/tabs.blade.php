...
<div class="page">
    ...
    <section class="breadcrumbs-custom bg-image context-dark scroll-handler" style="background-image: url(images/bg-breadcrumbs.jpg);">
        ...
        <div class="breadcrumbs-main">
            <div class="container">
                <h2 class="breadcrumbs-custom-title scroll-title">Tabs</h2>
            </div>
        </div>
        ...
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-lg-9 col-xl-8">
                    <!--Bootstrap tabs-->
                    <div class="tabs-custom tabs-classic" id="tabs-1">
                        <!--Nav tabs-->
    ...
    <section class="section section-lg bg-default text-center">
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-lg-9 col-xl-8">
                    <!--Bootstrap tabs-->
                    <div class="tabs-custom tabs-minimal" id="tabs-2">
                        <!--Nav tabs-->
                        <ul class="nav nav-tabs">
                    ...
                    <div class="col-md-3">
                        <div class="inset-xl-left-70">
                            ...
                            <ul class="contacts-modern">
                                ...
                                <li><a href="tel:#">+1 800 123 1234</a><br><a href="/cdn-cgi/l/email-protection#2c0f"><span class="__cf_email__" data-cfemail="fc95929a93bc9899919390959297d2938e9b">[email&#160;protected]</span></a></li>
                            </ul>
                        </div>
                    </div>
                </div>
